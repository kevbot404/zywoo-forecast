...
params = {
	...
	"end_date": "2024-08-12",
	"daily": ["weather_code", "temperature_2m_max", "apparent_temperature_max", "apparent_temperature_min", "sunrise", "sunset", "daylight_duration", "sunshine_duration", "rain_sum", "snowfall_sum", "precipitation_sum", "precipitation_hours", "wind_speed_10m_max", "wind_gusts_10m_max", "wind_direction_10m_dominant", "shortwave_radiation_sum", "et0_fao_evapotranspiration", "apparent_temperature_mean", "cloud_cover_mean", "cloud_cover_max", "cloud_cover_min", "dew_point_2m_min", "dew_point_2m_max", "dew_point_2m_mean", "et0_fao_evapotranspiration_sum", "relative_humidity_2m_mean", "relative_humidity_2m_max", "relative_humidity_2m_min", "snowfall_water_equivalent_sum", "pressure_msl_mean", "pressure_msl_max", "pressure_msl_min", "surface_pressure_mean", "surface_pressure_max", "surface_pressure_min", "wind_gusts_10m_mean", "wind_speed_10m_mean", "wind_gusts_10m_min", "wind_speed_10m_min", "wet_bulb_temperature_2m_mean", "wet_bulb_temperature_2m_max", "wet_bulb_temperature_2m_min", "vapour_pressure_deficit_max", "temperature_2m_min", "temperature_2m_mean"],
}
...
daily_apparent_temperature_mean = daily.Variables(17).ValuesAsNumpy()
daily_cloud_cover_mean = daily.Variables(18).ValuesAsNumpy()
daily_cloud_cover_max = daily.Variables(19).ValuesAsNumpy()
daily_cloud_cover_min = daily.Variables(20).ValuesAsNumpy()
...
daily_et0_fao_evapotranspiration_sum = daily.Variables(24).ValuesAsNumpy()
daily_relative_humidity_2m_mean = daily.Variables(25).ValuesAsNumpy()
daily_relative_humidity_2m_max = daily.Variables(26).ValuesAsNumpy()
daily_relative_humidity_2m_min = daily.Variables(27).ValuesAsNumpy()
daily_snowfall_water_equivalent_sum = daily.Variables(28).ValuesAsNumpy()
daily_pressure_msl_mean = daily.Variables(29).ValuesAsNumpy()
daily_pressure_msl_max = daily.Variables(30).ValuesAsNumpy()
daily_pressure_msl_min = daily.Variables(31).ValuesAsNumpy()
daily_surface_pressure_mean = daily.Variables(32).ValuesAsNumpy()
daily_surface_pressure_max = daily.Variables(33).ValuesAsNumpy()
daily_surface_pressure_min = daily.Variables(34).ValuesAsNumpy()
daily_wind_gusts_10m_mean = daily.Variables(35).ValuesAsNumpy()
daily_wind_speed_10m_mean = daily.Variables(36).ValuesAsNumpy()
daily_wind_gusts_10m_min = daily.Variables(37).ValuesAsNumpy()
daily_wind_speed_10m_min = daily.Variables(38).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_mean = daily.Variables(39).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_max = daily.Variables(40).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_min = daily.Variables(41).ValuesAsNumpy()
daily_vapour_pressure_deficit_max = daily.Variables(42).ValuesAsNumpy()
daily_temperature_2m_min = daily.Variables(43).ValuesAsNumpy()
daily_temperature_2m_mean = daily.Variables(44).ValuesAsNumpy()
