...
daily_pressure_msl_min = daily.Variables(26).ValuesAsNumpy()
daily_pressure_msl_max = daily.Variables(27).ValuesAsNumpy()
daily_pressure_msl_mean = daily.Variables(28).ValuesAsNumpy()
daily_snowfall_water_equivalent_sum = daily.Variables(29).ValuesAsNumpy()
daily_relative_humidity_2m_min = daily.Variables(30).ValuesAsNumpy()
daily_relative_humidity_2m_max = daily.Variables(31).ValuesAsNumpy()
daily_relative_humidity_2m_mean = daily.Variables(32).ValuesAsNumpy()
...
daily_soil_temperature_28_to_100cm_mean = daily.Variables(42).ValuesAsNumpy()
daily_soil_temperature_7_to_28cm_mean = daily.Variables(43).ValuesAsNumpy()
daily_soil_temperature_0_to_7cm_mean = daily.Variables(44).ValuesAsNumpy()
daily_soil_temperature_0_to_100cm_mean = daily.Variables(45).ValuesAsNumpy()
daily_soil_moisture_7_to_28cm_mean = daily.Variables(46).ValuesAsNumpy()
daily_soil_moisture_28_to_100cm_mean = daily.Variables(47).ValuesAsNumpy()
daily_soil_moisture_0_to_100cm_mean = daily.Variables(48).ValuesAsNumpy()
daily_soil_moisture_0_to_7cm_mean = daily.Variables(49).ValuesAsNumpy()
daily_vapour_pressure_deficit_max = daily.Variables(50).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_min = daily.Variables(51).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_max = daily.Variables(52).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_mean = daily.Variables(53).ValuesAsNumpy()
